...
public class DictionarySimple2{
...
class AV{
	...
	public void editWord(String a, String aNew){
		try{
			if(av.containsKey(a)){
				String tmp = av.get(a);
				DictionarySimple2.removeLineFromFile("Anh-Viet.txt", a+":"+tmp);
...
class VA{
	...
	public void editWord(String v, String vNew){
		try{
			if(va.containsKey(v)){
				String tmp = va.get(v);
				DictionarySimple2.removeLineFromFile("Viet-Anh.txt", v+":"+tmp);
